...
def app_header():
    ...
    static_css = """
        ...
        /* Role selection dropdown text color */
        [data-baseweb="select"] div[aria-selected] { color: #000000 !important; }
        [data-baseweb="select"] div[role="option"] { color: #000000 !important; }
